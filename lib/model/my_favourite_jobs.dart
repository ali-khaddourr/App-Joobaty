...
//
//     final myFavouritreModel = myFavouritreModelFromJson(jsonString);

import 'dart:convert';

MyFavouritreModel myFavouritreModelFromJson(String str) => MyFavouritreModel.fromJson(json.decode(str));

String myFavouritreModelToJson(MyFavouritreModel data) => json.encode(data.toJson());

class MyFavouritreModel {
  User user;
  ...
  factory MyFavouritreModel.fromJson(Map<String, dynamic> json) => MyFavouritreModel(
